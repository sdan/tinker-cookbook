...
Implements the suggested [RL memory test](https://github.com/thinking-machines-lab/tinker-project-ideas/blob/main/memorization-empirical-study.md) research project, measuring empirical learning rates under various reward functions.
